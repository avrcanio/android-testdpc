...
package mdm.qubit.dpc.util.flags;

import static mdm.qubit.dpc.util.flags.Flags.command;
import static mdm.qubit.dpc.util.flags.Flags.ordinalParam;
import static mdm.qubit.dpc.util.flags.Utils.asArgs;
import static com.google.common.truth.Truth.assertThat;

import mdm.qubit.dpc.util.flags.Utils.Callback10Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback11Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback12Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback13Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback14Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback15Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback16Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback1Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback2Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback3Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback4Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback5Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback6Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback7Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback8Arg;
import mdm.qubit.dpc.util.flags.Utils.Callback9Arg;
import mdm.qubit.dpc.util.flags.Utils.NoArgsCallback;
