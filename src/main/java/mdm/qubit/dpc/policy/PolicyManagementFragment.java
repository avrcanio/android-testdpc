...
package mdm.qubit.dpc.policy;

import static android.os.UserManager.DISALLOW_INSTALL_UNKNOWN_SOURCES;
import static mdm.qubit.dpc.common.preference.DpcPreferenceHelper.NO_CUSTOM_CONSTRAINT;
...
import mdm.qubit.dpc.AddAccountActivity;
import mdm.qubit.dpc.CrossProfileAppsAllowlistFragment;
import mdm.qubit.dpc.CrossProfileAppsFragment;
import mdm.qubit.dpc.DeviceAdminReceiver;
import mdm.qubit.dpc.DevicePolicyManagerGateway;
import mdm.qubit.dpc.DevicePolicyManagerGateway.FailedOperationException;
import mdm.qubit.dpc.DevicePolicyManagerGatewayImpl;
import mdm.qubit.dpc.FileLogger;
import mdm.qubit.dpc.R;
import mdm.qubit.dpc.SetupManagementActivity;
import mdm.qubit.dpc.common.AccountArrayAdapter;
import mdm.qubit.dpc.common.AppInfoArrayAdapter;
import mdm.qubit.dpc.common.BaseSearchablePolicyPreferenceFragment;
import mdm.qubit.dpc.common.CertificateUtil;
import mdm.qubit.dpc.common.Dumpable;
import mdm.qubit.dpc.common.MediaDisplayFragment;
import mdm.qubit.dpc.common.PackageInstallationUtils;
import mdm.qubit.dpc.common.ReflectionUtil;
import mdm.qubit.dpc.common.ReflectionUtil.ReflectionIsTemporaryException;
import mdm.qubit.dpc.common.UserArrayAdapter;
import mdm.qubit.dpc.common.Util;
import mdm.qubit.dpc.common.preference.CustomConstraint;
import mdm.qubit.dpc.common.preference.DpcEditTextPreference;
import mdm.qubit.dpc.common.preference.DpcPreference;
import mdm.qubit.dpc.common.preference.DpcPreferenceBase;
import mdm.qubit.dpc.common.preference.DpcPreferenceHelper;
import mdm.qubit.dpc.common.preference.DpcSwitchPreference;
import mdm.qubit.dpc.comp.BindDeviceAdminFragment;
import mdm.qubit.dpc.EnrolApiClient;
import mdm.qubit.dpc.EnrolState;
import mdm.qubit.dpc.policy.blockuninstallation.BlockUninstallationInfoArrayAdapter;
import mdm.qubit.dpc.policy.certificate.DelegatedCertInstallerFragment;
import mdm.qubit.dpc.policy.keyguard.LockScreenPolicyFragment.Container;
import mdm.qubit.dpc.policy.keyguard.PasswordConstraintsFragment;
import mdm.qubit.dpc.policy.keymanagement.GenerateKeyAndCertificateTask;
import mdm.qubit.dpc.policy.keymanagement.KeyGenerationParameters;
import mdm.qubit.dpc.policy.keymanagement.SignAndVerifyTask;
import mdm.qubit.dpc.policy.locktask.KioskModeActivity;
import mdm.qubit.dpc.policy.locktask.LockTaskAppInfoArrayAdapter;
import mdm.qubit.dpc.policy.locktask.SetLockTaskFeaturesFragment;
import mdm.qubit.dpc.policy.networking.AlwaysOnVpnFragment;
import mdm.qubit.dpc.policy.networking.NetworkUsageStatsFragment;
import mdm.qubit.dpc.policy.networking.PrivateDnsModeFragment;
import mdm.qubit.dpc.policy.resetpassword.ResetPasswordWithTokenFragment;
import mdm.qubit.dpc.policy.systemupdatepolicy.SystemUpdatePolicyFragment;
import mdm.qubit.dpc.policy.wifimanagement.WifiConfigCreationDialog;
import mdm.qubit.dpc.policy.wifimanagement.WifiEapTlsCreateDialogFragment;
import mdm.qubit.dpc.policy.wifimanagement.WifiModificationFragment;
import mdm.qubit.dpc.profilepolicy.ProfilePolicyManagementFragment;
import mdm.qubit.dpc.profilepolicy.addsystemapps.EnableSystemAppsByIntentFragment;
import mdm.qubit.dpc.profilepolicy.apprestrictions.AppRestrictionsManagingPackageFragment;
import mdm.qubit.dpc.profilepolicy.apprestrictions.ManagedConfigurationsFragment;
import mdm.qubit.dpc.profilepolicy.delegation.DelegationFragment;
import mdm.qubit.dpc.profilepolicy.permission.ManageAppPermissionsFragment;
import mdm.qubit.dpc.transferownership.PickTransferComponentFragment;
import mdm.qubit.dpc.util.MainThreadExecutor;
