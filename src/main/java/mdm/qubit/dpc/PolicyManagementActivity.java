...
import mdm.qubit.dpc.common.DumpableActivity;
import mdm.qubit.dpc.common.OnBackPressedHandler;
import mdm.qubit.dpc.policy.PolicyManagementFragment;
import mdm.qubit.dpc.search.PolicySearchFragment;
...
public class PolicyManagementActivity extends DumpableActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (getResources().getBoolean(R.bool.config_lite_mode)) {
      startActivity(new Intent(this, mdm.qubit.dpc.lite.LiteEntryActivity.class));
      finish();
      return;
    }
