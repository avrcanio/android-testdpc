...
package mdm.qubit.dpc.provision;
...
import mdm.qubit.dpc.FinalizeActivity;
import mdm.qubit.dpc.common.LaunchIntentUtil;
import mdm.qubit.dpc.common.Util;
import mdm.qubit.dpc.cosu.EnableCosuActivity;
...
public class PostProvisioningTask {
  ...
  private static final String SETUP_MANAGEMENT_LAUNCH_ACTIVITY =
      "mdm.qubit.dpc.SetupManagementLaunchActivity";
